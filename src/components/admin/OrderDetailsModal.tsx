        ...
        <MechanicalCard hover={false}>
          <div className="p-6">
                ...
                <div className="bg-gray-800 rounded-lg p-6 border border-gray-600">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-blue-400 font-semibold">{order.phoneNumber}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-bold ${
                        order.orderType === 'takeaway' ? 'bg-blue-600 text-white' : 'bg-green-600 text-white'
                      }`}>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-white">{formatTime(order.timestamp)}</span>
                    </div>
                ...
                <div className="bg-gray-800 rounded-lg p-4 border border-gray-600 mt-6">
                  <div className="space-y-2">
                    <div className="flex justify-between text-gray-300">
                      ...
                      <span>${order.items.reduce((sum, item) => sum + item.totalPrice, 0).toFixed(2)}</span>
                    </div>
            ...
            <div className="flex justify-end mt-8">
              <MechanicalButton onClick={onClose} variant="secondary">
                Close
              </MechanicalButton>
            </div>
          </div>
